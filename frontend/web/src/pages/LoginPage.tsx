...
const LoginPage: React.FC = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-secondary-800 text-white font-sans">
      <h1 className="text-4xl font-bold mb-8 text-primary-500">Login</h1>
      <form onSubmit={handleLogin} className="flex flex-col gap-4 p-8 rounded-lg bg-secondary-700 shadow-lg w-80">
        <div className="flex flex-col">
          ...
          <input
            ...
            id="username"
            name="username"
            className="input" // Using the custom 'input' class from index.css
            value={username}
      ...
      <p className="mt-8 text-sm text-gray-400">
        Don't have an account? <a href="/register" className="text-accent-cyan hover:underline">Register here</a>
      </p>
    </div>
  );
};
